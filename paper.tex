...
We derive closed form formulae for the Cram\'{e}r-Rao  lower bounds of these parameters under the assumption that the noise is additive white and Gaussian.  This is achieved by making use of a family of orthogonal polynomials.
\end{abstract}
